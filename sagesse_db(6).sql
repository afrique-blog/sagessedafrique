...
--
-- Hôte : localhost:3306
-- Généré le : mar. 06 jan. 2026 à 04:29
...
ALTER TABLE `comments`
  ADD PRIMARY KEY (`id`),
  ADD KEY `comments_article_id_fkey` (`article_id`);
...
--
ALTER TABLE `comments`
  ADD CONSTRAINT `comments_article_id_fkey` FOREIGN KEY (`article_id`) REFERENCES `articles` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
