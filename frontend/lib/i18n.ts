...
export const translations = {
  fr: {
    ...
    startHereDesc: 'Nouveaux sur Sagesse d\'Afrique ? Voici par où commencer.',
    discoverPersonalities: 'Découvrir les Personnalités',
    discoverPersonalitiesDesc: 'Explorez les figures qui ont façonné l\'Afrique.',
    exploreCategories: 'Explorer les Catégories',
    exploreCategoriesDesc: 'Parcourez nos thématiques par sujet.',
    readDossiers: 'Lire les Dossiers',
    readDossiersDesc: 'Plongez dans nos enquêtes approfondies.',
    featured: 'À la Une',
  ...
  en: {
    ...
    startHereDesc: 'New to Sagesse d\'Afrique? Here\'s where to begin.',
    discoverPersonalities: 'Discover Personalities',
    discoverPersonalitiesDesc: 'Explore the figures who shaped Africa.',
    exploreCategories: 'Explore Categories',
    exploreCategoriesDesc: 'Browse our themes by topic.',
    readDossiers: 'Read Dossiers',
    readDossiersDesc: 'Dive into our in-depth investigations.',
    featured: 'Featured',
