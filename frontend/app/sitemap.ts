...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages = [
    ...
    { url: `${BASE_URL}/ressources`, lastModified: new Date(), changeFrequency: 'monthly' as const, priority: 0.8 },
    { url: `${BASE_URL}/editorial-policy`, lastModified: new Date(), changeFrequency: 'yearly' as const, priority: 0.6 },
