        ...
        <section className="bg-primary text-white py-20">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-white/80 max-w-2xl mx-auto text-lg">
              {lang === 'fr' 
                ? "Explorez nos différentes thématiques pour découvrir la richesse du patrimoine africain"
                : "Explore our different themes to discover the richness of African heritage"}
            </p>
          </div>
        </section>
              ...
              >
                <div className="relative h-56 bg-slate-100 dark:bg-slate-700">
                  ...
                  <div className="absolute bottom-4 left-4 right-4">
                    <h2 className="text-xl font-serif font-bold text-white">{cat.name}</h2>
                    <span className="text-white/80 text-sm">
                      {cat.articleCount} {lang === 'fr' ? 'articles' : 'articles'}
                    </span>
                  </div>
                </div>
                <div className="p-6">
                  <p className="text-slate-600 dark:text-slate-400 text-sm line-clamp-3">
                    {cat.description || (lang === 'fr' ? 'Découvrez cette catégorie' : 'Discover this category')}
                  </p>
